...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'inventory-manager', 'product-manager', 'warehouse-supervisor'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Warehouse', path: '/warehouses', entity: 'warehouse', service: AccessServiceEnum.PROJECT, icon: FiHome },
    {
