    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="traceability_code" mb="4" isInvalid={!!formik.errors?.traceability_code}>
            <FormLabel>Traceability Code</FormLabel>
            <Input
              type="text"
              name="traceability_code"
              value={formik.values?.traceability_code}
              onChange={formik.handleChange}
            />
            {formik.errors.traceability_code && <FormErrorMessage>{formik.errors?.traceability_code}</FormErrorMessage>}
          </FormControl>
