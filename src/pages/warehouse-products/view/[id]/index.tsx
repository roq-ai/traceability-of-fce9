...
import { getWarehouseProductById } from 'apiSdk/warehouse-products';
...
function WarehouseProductViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Warehouse Product Detail View
          </Text>
          {hasAccess('warehouse_product', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/warehouse-products/edit/${data?.id}`} passHref legacyBehavior>
              <Button
